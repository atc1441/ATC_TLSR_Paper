...
_attribute_ram_code_ int8_t EPD_BWR_213_read_temp(void)
{
...
_attribute_ram_code_ int8_t EPD_BWR_213_Display(unsigned char *image, int size, uint8_t full_or_partial)
{    
    int8_t epd_temperature = 0 ;
